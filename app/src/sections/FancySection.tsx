...
export function FancySection() {
  ...
  const productA = products[3]; // Silk Scrunchie Set
  const productB = products[4]; // Mini Perfume Roller

  return (
    <section
      ref={sectionRef}
      className="section-pinned bg-[#F6F6F2] relative overflow-hidden z-20"
    >
      {/* Gradient Overlay */}
      ...
      <motion.div
        ...
        className="absolute left-[35vw] top-[15vh] w-4 h-4 rounded-full bg-[#ffa07a]/40"
      />
      <motion.div
        style={{ opacity: contentOpacity }}
        className="absolute right-[20vw] bottom-[15vh] decorative-ring w-20 h-20 opacity-20"
      />
        ...
        <div className="w-full px-6 lg:px-[6vw]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <motion.div style={{ opacity: contentOpacity }}>
              ...
              >
                Elevated essentials that make everyday feel special.
              </motion.p>
